...
class AverageStrategy(AccumulatedStrategy):
    ...
    def execute(self, payload: Dict[str, Any], policy_params: Dict[str, Any], dispositivo_id: str) -> Optional[Dict[str, Any]]:
        ...
        if not isinstance(data_point_value, (int, float)):
            print(f"Erro: Valor do ponto de dado não é um número para o dispositivo {dispositivo_id}.")
            return None
        cache_manager.add_data_point(dispositivo_id, titular_id, data_point_value)
